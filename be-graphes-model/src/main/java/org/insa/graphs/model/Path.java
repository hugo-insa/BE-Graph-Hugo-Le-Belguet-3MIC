...
public class Path {
        	...
        	while(iterNodes.hasNext()) {
        		...
        		while(iterArcs.hasNext()) {
        			...
        			if (arc.getDestination().equals(destination)) {
        				...
        				if (arc.getMinimumTravelTime() < faster_arc.getMinimumTravelTime()) {
        					faster_arc = arc;
        				}
        			}
        		}
        	...
        	while(iterNodes.hasNext()) {
        		...
        		while(iterArcs.hasNext()) {
        			...
        			if (arc.getDestination().equals(destination)) {
        				...
        				if (arc.getLength() < faster_arc.getLength()) {
        					faster_arc = arc;
        				}
        			}
        		}
    ...
    public float getLength() {
    	...
    	for(i = 0; i < this.arcs.size(); i++) {
    		length = length + this.arcs.get(i).getLength();
    	}
        return length;
    }
    ...
    public double getTravelTime(double speed) {
        ...
        int i = 0;
    	for(i = 0; i < this.arcs.size(); i++) {
    		time = time + this.arcs.get(i).getTravelTime(speed);
    	}
        return time;
    }
